...
//         article.innerHTML = `<p>${dummytexts[random]}</p>`;
//     }else{
//         let slicedArray = dummytexts.slice(0, value);
//         let finalArray = slicedArray
//         .map(function (singleDummy) {
//         return `<p>${singleDummy}</p>`;
//         })
//         .join('');
//         article.innerHTML = finalArray;
//     }
// })
// dummy text project ENd

// copy redeem code project start
// let input = document.getElementById("inputtext");
// let btn = document.getElementById("copying");
...
//     alert("Copied")
// }
// copy redeem code project End

// my datalist project start
...
// });
//start from 30 minutes of traversy media channel Booklist project video

// localStorage.setItem("tableusername",JSON.stringify(username.value))
// localStorage.setItem("tablepassword",JSON.stringify(password.value))
// localStorage.setItem("tableemail",JSON.stringify(email.value))
// my datalist project End----after complete tip calculator project, learn localstorage !!!!!!!!!!!!!!!!!!~~~~~~~~~    important    ~~~~~~~!!!!!!!!!!!!!!!!

// tipcalculator project start
// let tipform = document.querySelector("#tip-form").onchange = ()=>{
...
//     let tipvalue = totalbill *tipInput/100
//     let finalvalue = tipvalue+totalbill
//     tipAmount.value = tipvalue.toFixed(2)
//     totalBillWithTip.value = finalvalue.toFixed(2)
//     tipOutput.innerHTML = `${tipInput}%`
//     result.style.display = "block"
// }
// tipcalculator project End



// learn asynchronous programming (Average Done)
// learn ajax (Learning Continue)
// learn jquery
// complete some project of my own
// start from 190 number video

//Ajax server request start
...
//     })
// }
// let res = getRequest(`${Base_URL}/users`)
// console.log(res)
//Ajax server request End -----------

// AJAX GET REQUEST Start (DOM)
...
//     // e.preventDefault() ( That's For Testing Browser (Optional))
//     fetch(URL)
//         .then(response => response.json())
//         .then(posts => {
//             posts.forEach((post, index) => {
//                 let listItem = listgenerator(post, index + 1)
...
// function listgenerator(item, no) {
...
// AJAX GET REQUEST End (DOM)

// learn rest api
// complete the playlist within this month
// learn jquery
// learn frameworks later
...
const API_KEY = '4fa84c088ff97e4a6166ae22507899b0'
